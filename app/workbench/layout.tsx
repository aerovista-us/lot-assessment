  ...
  return <>
    <div style={{position:"sticky",top:0,zIndex:90,display:"flex",justifyContent:"center",background:"#0b1729",borderBottom:"1px solid #ffffff18",padding:"7px 12px"}}>
      <nav style={{width:"min(1180px,100%)",display:"flex",justifyContent:"flex-end",gap:7,flexWrap:"wrap"}} aria-label="Workbench vNext tools">
        <Link href="/workbench" style={{color:"#d7e0ea",textDecoration:"none",fontSize:10,fontWeight:900,letterSpacing:".06em",border:"1px solid #ffffff24",borderRadius:999,padding:"6px 9px"}}>WORKBENCH</Link>
        <Link href="/workbench/automation" style={{color:"#d7e0ea",textDecoration:"none",fontSize:10,fontWeight:900,letterSpacing:".06em",border:"1px solid #ffffff24",borderRadius:999,padding:"6px 9px"}}>AUTOMATION</Link>
        <Link href="/workbench/report" style={{color:"#d7e0ea",textDecoration:"none",fontSize:10,fontWeight:900,letterSpacing:".06em",border:"1px solid #ffffff24",borderRadius:999,padding:"6px 9px"}}>USER REPORT</Link>
