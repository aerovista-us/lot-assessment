...
export default function ProvenPatterns() {
  return <main className={styles.shell}>
    ...
    <section className={styles.proof}><strong>Regression proof: PASS</strong><span>The Workbench regression gate requires at least five materially distinct promotion-ready concepts. These two examples are retained reference patterns; durable benchmark evidence is persisted in GitHub.</span></section>
    <section className={styles.grid}>
      <article className={styles.card}><div className={styles.cardhead}><div><span>DESIGN #1</span><h2>Setback Spine</h2></div><b>PROVEN</b></div><SiteDiagram/><p>Our control concept: front/rear residential masses with a long edge-access spine. Strong circulation margin and retained as a proven benchmark/control rather than an automatic winner.</p><div className={styles.metrics}><span>FS-SUV clearance<strong>2.24 ft</strong></span><span>Unit A capacity<strong>2,050 sf</strong></span><span>Unit B capacity<strong>2,000 sf</strong></span></div></article>
