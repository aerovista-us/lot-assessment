...
const candidate = {
  ...
  placements: [
    ...
    { id:"GARAGE-A", kind:"garage", x:100, y:7, widthFt:20, depthFt:20, movable:false, integrationGroupId:"unit-A" },
    { id:"HOME-B", kind:"home", x:30, y:5, widthFt:40, depthFt:28, movable:false, integrationGroupId:"unit-B" },
    { id:"GARAGE-B", kind:"garage", x:50, y:7, widthFt:20, depthFt:20, movable:false, integrationGroupId:"unit-B" }
  ],
  drives: [],
